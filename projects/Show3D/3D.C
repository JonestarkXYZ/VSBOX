...
int main() {
    ...
    loadModel("C:\\projects\\Show3D\\models\\model1.txt");
    drawModel(WHITE);
    loadModel("C:\\projects\\Show3D\\models\\model2.txt");
    drawModel(RED);
    loadModel("C:\\projects\\Show3D\\models\\model3.txt");
    drawModel(GREEN);
    loadModel("C:\\projects\\Show3D\\models\\model4.txt");
    drawModel(BLUE);
    loadModel("C:\\projects\\Show3D\\models\\model5.txt");
    drawModel(YELLOW);
